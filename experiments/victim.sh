...
for i in 2 
do
    OUTDIR=outputs_attack/${DATASET}/poison-10-task-target-$i
    NOISE_PATH=/home/ubuntu/neurips2024/aob/CODA-Prompt/outputs/cifar-100/poison-10-task-target-2/l2p++/triggers/repeat-1/task-trigger-gen/target-2-04-10-04_11_38.npy
    mkdir -p $OUTDIR
